...
acl:
    admin:
        - user:
        {%- if env['EJABBERD_EXT_ADMINS'] %}
            {%- for admin in env['EJABBERD_EXT_ADMINS'].split() %}
...
#        params:
#          key: "secret"
#          allowed_commands: [status, add_rosteritem, create_room, send_direct_invitation, set_room_affiliation, connected_users_info]
...
###   SQL DATABASE CONFIG
    ...
    sql_pool_size: {{ env['EJABBERD_SQL_POOL_SIZE'] }}
{% endif %}
...
commands_admin_access: remote_commands
commands:
  - add_commands: open
